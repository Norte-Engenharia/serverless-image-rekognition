...
# image_url = 
curl "${invoke_url}/analysis?imageUrl=https://global-norte.s3.amazonaws.com/dashboard/6495dabc599fea2ab32ff48b/images/d37d9a4d0d7f543de156076c4e2f4816-GSAI4530.JPG" > output.json